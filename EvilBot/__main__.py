...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`�Konnichiwa {first} [🦇](https://telegra.ph/file/60313740175211b4ac0af.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕�Add me to your Mansion➕", url="t.me/EVIL_XOBOT?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="�About Ruki Mukami", callback_data="evil_"),
        InlineKeyboardButton(text="Ruki Updates", url="https://t.me/plexus_bots_updates),
     ],
     [  
        InlineKeyboardButton(text="🛠 �support 🛠", url="https://t.me/Ruki_support"),
        InlineKeyboardButton(text="�🗼 Ruki Logs 🗼", url="https://t.me/Ruki_global_logs"),
    ], 
...
evil_IMG = "https://telegra.ph/file/60313740175211b4ac0af.jpg"
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @MikuMakno04 \
