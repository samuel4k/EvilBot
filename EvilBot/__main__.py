...
click /help to check some of things that I can help with   
"""
buttons = [
    [
     ...
     [
        ...
        InlineKeyboardButton(
            text="�Ruki Mukami 𝐖𝐞𝐛�", url=f"http://evilbotz.art.blog"
        ),
     ],
     [  
        InlineKeyboardButton(text="🛠 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 🛠", url="https://t.me/EVIL_SUPPORT_CHAT"),
        InlineKeyboardButton(text="�📚 Ruki Logs�📚", url="https://github.com/shrvan42/EvilBot"),
    ], 
